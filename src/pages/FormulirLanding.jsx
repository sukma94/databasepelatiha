...
import { Users, Sun, Moon, Calendar, FileText, ArrowLeft, ArrowRight, ClipboardList } from 'lucide-react';
import './PublicPeserta.css';
import './PublicLanding.css';
import { isLevelArchived } from '../utils/dateUtils';

export default function FormulirLanding() {
            ...
            <section className="pl-hero-section">
                <div className="pl-hero-content">
                    ...
                    <p className="pl-hero-subtitle">
                        Pilih jenis pelatihan lalu isi formulir data diri Anda untuk mendaftar sebagai peserta.
                    </p>
                ...
                <div className="pl-cards-container">
                    {publishedLevels.length === 0 ? (
                        <div className="pl-empty-state">
                            ...
                            <h2 className="pl-empty-title">Belum Ada Formulir Tersedia</h2>
                            <p className="pl-empty-desc">
                                Belum ada pelatihan yang membuka formulir saat ini.
                            </p>
                        </div>
                    ) : (
                        <>
                            <div className="pl-section-header">
                                ...
                                <p className="pl-section-desc">Klik salah satu untuk mengisi formulir data diri</p>
                            </div>
